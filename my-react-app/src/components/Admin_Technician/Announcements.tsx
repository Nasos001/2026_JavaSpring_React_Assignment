...
export default function Announcements() {
    ...
    const handleAnnouncement = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                throw new Error("Error when creating Announcement:" + msg);
            }
        } catch(error) {
            console.error(error);
    ...
    // --------------------------------------------------------------------------------------------------------------------
    return(
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 h-screen flex items-center justify-center text-center">
            ...
            <div className="w-full max-w-lg">
                ...
                {/* Success */}
                {success && (
                <p className="rounded-lg mx-auto p-3 text-lg mb-5 bg-green-300">
                    Successful Announcement!
                </p>
                )}

                <form className="space-y-4 mt-10" onSubmit={handleAnnouncement}>
                {/* Title */}
                <div>
